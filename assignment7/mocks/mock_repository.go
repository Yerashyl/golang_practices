...
func (m *MockUserRepository) CreateUser(user *assignment7.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) GetByEmail(email string) (*assignment7.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByEmail", email)
	ret0, _ := ret[0].(*assignment7.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockUserRepository) GetUserByID(id int) (*assignment7.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateUser(user *assignment7.User) error {
	m.ctrl.T.Helper()
